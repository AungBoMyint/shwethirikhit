...
class AppColor{
  ...
  static  Color gradientFirst=const Color.fromRGBO(85,38,38, 1);
  static  Color gradientSecond=const Color.fromRGBO(85,38,38, 1);
  static  Color homePageTitle=const Color.fromRGBO(85,38,38, 1);
  static  Color homePageSubtitle=const Color.fromRGBO(85,38,38, 1);
  ...
  static Color secondPageTitleColor= const Color(0xFFf4f5fd);
